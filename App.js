       ...
       <Tabs>
          ...
          <List>
            <ListItem avatar style={{marginBottom:10}}>
              <Left>
                <Thumbnail source={require("./assets/images/apalo.jpg")} />
              </Left>
              <Body>
                <Text>Saleh</Text>
                <Text note>Aapalo!</Text>
              </Body>
              <Right>
          ...
          <ListItem avatar style={{marginBottom:5}} noBorder>
            ...
            <ListItem avatar style={{marginBottom:5}}>
              <Left>
                <Thumbnail source={require("./assets/images/apalo.jpg")}  style={{padding:5, backgroundColor:"#ffffff",borderWidth: 2.5, borderColor: "#075e54"}} />
              </Left>
              <Body>
                <Text>Dedi</Text>
                <Text note>Today 07.20 pm</Text>
              </Body>
            </ListItem>
            <Separator bordered style={{marginTop:5}}>
            ...
            <ListItem avatar style={{marginBottom:5}}>
              <Left>
                <Thumbnail source={require("./assets/images/apalo.jpg")} style={{borderWidth: 2.5, borderColor: "#dbd8d5"}} />
              </Left>
              <Body>
                <Text>Saul</Text>
